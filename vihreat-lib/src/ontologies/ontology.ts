...
declare module '@tomic/lib' {
  interface Classes {
    ...
    requires: BaseProps | typeof ontology.properties.title | typeof ontology.properties.elements;
    recommends: typeof ontology.properties.subtitle | typeof ontology.properties.approvedon | typeof ontology.properties.updatedon | typeof ontology.properties.retiredon | typeof ontology.properties.staleon;
  };
[ontology.classes.title]: {
    requires: BaseProps | typeof ontology.properties.text | typeof ontology.properties.titlelevel;
    recommends: never;
  };
